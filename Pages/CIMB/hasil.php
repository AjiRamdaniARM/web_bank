...
<head>
  ...
  <div class="container-hp  border border-dark shadow-lg text-center" style="height: 900px;">
    <div class="container-lg">
        <div class="block border border-dark mt-4 ">
           ...
           <div class=" w-full text-start m-2 d-flex justify-content-between align-items-start">
            ...
            <div class="w-full text-start d-flex align-items-start " style="background-color: #D3E3CD;">
            <div class="icon mt-2 m-2">
              <img src="../../image/check.png"  width="20" alt="check">
            </div>
            <div class="text">
            <div class="m-2 me-5 fw-bold" style="color: green;" style="font-family:'Roboto',sans-serif ; font-size: 10px;">Successful</div>
            <div class="m-2 me-5" style="color: black; position:relative; top: -12px;font-family:'Roboto',sans-serif; font-size: 10px;" >Ref603402623</div>
            <div class="m-2 me-5"style="color: black; position:relative; top: -25px;font-family:'Roboto',sans-serif ;font-size: 10px;"><?php 
            ...
            <div class=" w-full text-start p-1 border-dark border-bottom " style="background-color: #EEEEEE; ">
            <div class="ms-3">
              <h5 style="font-family:'Roboto',sans-serif; font-weight: bold; font-size: 10px;">To</h5>
        ...
        <div class=" w-full text-start p-1 border-bottom  border-dark " style="background-color: #EEEEEE;">
            <div class="ms-3">
              <h5 style="font-family:'Roboto',sans-serif; font-weight: bold; font-size: 10px;">When</h5>
               <div class="row align-items-center">
                <div class="col">
                  <div class="account_number">
    ...
    <div class="w-full text-start p-1 border-bottom border-dark" style="background-color: #EEEEEE; ">
      <div class="m-4">
        <h5 style="font-family: 'Roboto',sans-serif; font-weight:bold;font-size: 10px;"> Amount</h5>
        <div class="row align-items-center">
      ...
      <div class="w-full text-start p-1 border-bottom border-dark" style="background-color: #EEEEEE;">
      <div class="ms-3">
        <h5 style="font-family: 'Roboto',sans-serif; font-weight:bold;font-size: 10px;">Transaction Instruction</h5>
        <div class="row align-items-center">
